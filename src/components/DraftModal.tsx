...
import {
  ...
  User, Loader2, ChevronDown, ChevronUp
} from 'lucide-react';
...
type TabType = 'whatsapp' | 'email' | 'telegram';
...
export default function DraftModal({
  ...
  const tgLink = tgRecipient
    ? `https://t.me/${tgRecipient.replace('@', '')}` // open chat with specific user
                ...
                <>
                  ...
                  <div style={{ padding: '1.25rem 1.5rem' }}>
                    ...
                    <p style={{ fontSize: '0.7rem', color: 'var(--color-text-muted)', marginTop: '0.375rem' }}>
                      ✏️ Kamu bisa edit teks di atas sebelum mengirim.
                    </p>
                  </div>
